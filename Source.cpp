...
int main(int argc, char** argv) {
	...
	//GLuint VBO;										/* инициализировали глобальную переменную дл€ хранени€ указател€ (впоследстви
	//												*	укажем, что указатель будет на буфер вершин)*/
	// сделал еЄ действительно глобальной...
	...
	glBufferData(GL_ARRAY_BUFFER,	sizeof(vecArr),		vecArr,			GL_STATIC_DRAW);	/* наполнили объект данными:
				 название цели		размер данных (б)	адрес массива	флаг использовани€ паттернов: без изменений значений буфера
																							*/
